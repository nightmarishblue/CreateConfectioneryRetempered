...
public class CCConstants {
    ...
    public static final int STIMULATION_DURATION = 20 * 60 * 2;
    ...
    public static final int REGENERATION_DURATION = 20 * 5;
    ...
    public static final List<MobEffectInstance> RUBY_CHOC_EFFECTS = List.of(new MobEffectInstance(MobEffects.HEALTH_BOOST, HEALTH_DURATION, 1));
    public static final List<MobEffectInstance> WHITE_CHOC_EFFECTS = List.of(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, SPEED_DURATION));
    ...
    public static final List<MobEffectInstance> CARAMEL_EFFECTS = List.of(new MobEffectInstance(MobEffects.REGENERATION, REGENERATION_DURATION));
