...
import blue.nightmarish.create_confectionery.entity.custom.GingerbreadManEntity.Decay;
...
public class GingerbreadManRenderer extends MobRenderer<GingerbreadManEntity, GingerbreadManModel> {
    public static final List<ResourceLocation> TEXTURE_TRACK = new ArrayList<>(Decay.values().length);
    ...
    public GingerbreadManRenderer(EntityRendererProvider.Context pContext) {
        ...
        Decay[] decayStates = Decay.values();
